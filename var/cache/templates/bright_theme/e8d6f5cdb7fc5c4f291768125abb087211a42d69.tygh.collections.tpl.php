<?php /* Smarty version Smarty-3.1.21, created on 2021-09-03 17:48:56
         compiled from "C:\OpenServer\domains\cscart\design\themes\responsive\templates\views\products\collections.tpl" */ ?>
<?php /*%%SmartyHeaderCode:101426523613235d8e734d4-60116823%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '101426523613235d8e734d4-60116823',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_613235d8f272c1_36137376',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_613235d8f272c1_36137376')) {function content_613235d8f272c1_36137376($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\function.script.php';
...
if ($_smarty_tpl->tpl_vars['collections']->value) {?>
    ...
    <div class="grid-list">
        <?php  $_smarty_tpl->tpl_vars["sollections"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["sollections"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['splitted_collections']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["sollections"]->key => $_smarty_tpl->tpl_vars["sollections"]->value) {
$_smarty_tpl->tpl_vars["sollections"]->_loop = true;
$_smarty_tpl->tpl_vars["collection"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["collection"]->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['sollections']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
</a></div><div class="ty-grid-list__item-name"><bdi><a href="<?php echo htmlspecialchars(fn_url("products.collections?collection_id=".((string)$_smarty_tpl->tpl_vars['collection']->value['collection_id'])), ENT_QUOTES, 'UTF-8');?>
