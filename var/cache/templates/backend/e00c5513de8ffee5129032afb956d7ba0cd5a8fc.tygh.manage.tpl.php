<?php /* Smarty version Smarty-3.1.21, created on 2021-09-05 11:15:25
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\addons\gift_certificates\views\gift_certificates\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27826255261347c9d37cca8-39998204%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e00c5513de8ffee5129032afb956d7ba0cd5a8fc' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\addons\\gift_certificates\\views\\gift_certificates\\manage.tpl',
      1 => 1628148740,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '27826255261347c9d37cca8-39998204',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61347c9d4449e9_69804736',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61347c9d4449e9_69804736')) {function content_61347c9d4449e9_69804736($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\function.script.php';
...
" class="cm-item cm-item-status-<?php echo htmlspecialchars(mb_strtolower($_smarty_tpl->tpl_vars['gift']->value['status'], 'UTF-8'), ENT_QUOTES, 'UTF-8');?>
 hide" />
                            ...
                            <td data-th="<?php echo $_smarty_tpl->__("code");?>
">
...
" class="row-status"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['sender'], ENT_QUOTES, 'UTF-8');?>
</td>
                            <td data-th="<?php echo $_smarty_tpl->__("gift_cert_to");?>
" class="row-status"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['recipient'], ENT_QUOTES, 'UTF-8');?>
</td>
                            <td data-th="<?php echo $_smarty_tpl->__("type");?>
" class="row-status"><span class="nowrap"><?php if ($_smarty_tpl->tpl_vars['gift']->value['send_via']=="P") {
...
" class="underlined"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['gift']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'UTF-8');?>
                            ...
                            <td data-th="<?php echo $_smarty_tpl->__("current_amount");?>
